...
public class IndexFragment_92710 extends Fragment {
    ...
    private LinearLayout Lpower_ac, Lpower_plug, Lpower_all,Lprice_month;
    ...
    private Timer timer;
    public IndexFragment_92710() {
        // Required empty public constructor
    }

    public static IndexFragment_92710 newInstance(String param1, String param2) {
        IndexFragment_92710 fragment = new IndexFragment_92710();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_index_92710, container, false);
    }
        ...
        postRequest = new StringRequest(Request.Method.POST, url_electricity, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    Log.d("92710_electricity", object.toString());
                    ...
                    settingedit.putString("price_92710",accumulate_consumption).commit();
    ...
    private void getGeneral() {
        ...
        postRequest = new StringRequest(Request.Method.POST, url_general, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    JSONObject object = new JSONObject(response);
                    Log.d("92710_general", object.toString());
                    JSONArray data = object.getJSONArray("data");
    ...
    private void getPower() {
        ...
        postRequest = new StringRequest(Request.Method.POST, url_ami, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    JSONObject object = new JSONObject(response);
                    Log.d("92710，Hoem_ami", object.toString());
                    JSONArray data = object.getJSONArray("data");
